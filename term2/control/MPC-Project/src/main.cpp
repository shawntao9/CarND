    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
           ...
           */
          //transform waypoints coordinates to vehicle coordinates
          size_t n_waypoints = ptsx.size();
          VectorXd ptsx_transformed(n_waypoints);
          VectorXd ptsy_transformed(n_waypoints);
          ...
          //fit points to polynomial, 3rd order
          ...
          double epsi = psi0 - atan(coeffs[1]) ;
